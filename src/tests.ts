...
let book1 = new Book("Harry Potter", "Pedra Filosofal", new Date('1997-06-26T00:00:00'), person1)
let person2 = new Person('Junin', new Date('1970-05-16T00:00:00'), Gender.Male)
let book2 = new Book("A Cabana", "O Despertar", new Date('2000-05-04T00:00:00'), person2)
let person3 = new Person('Roberta', new Date('1968-07-21T00:00:00'), Gender.Female)
let book3 = new Book("Diário de um banana", "Rodrick é o cara", new Date('2009-09-15T00:00:00'), person3)
